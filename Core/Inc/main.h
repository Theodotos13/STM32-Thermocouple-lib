...
#define ColdJunction_Pin GPIO_PIN_1
#define ColdJunction_GPIO_Port GPIOA
#define NTC_10_kOhm_Pin GPIO_PIN_2
#define NTC_10_kOhm_GPIO_Port GPIOA
#define PT100_Pin GPIO_PIN_3
#define PT100_GPIO_Port GPIOA
#define Voltage_Ref_Pin GPIO_PIN_4
#define Voltage_Ref_GPIO_Port GPIOA
#define MAX6675_CS_Pin GPIO_PIN_12
#define MAX6675_CS_GPIO_Port GPIOB
#define MAX6675_SCK_Pin GPIO_PIN_13
#define MAX6675_SCK_GPIO_Port GPIOB
#define MAX6675_SO_Pin GPIO_PIN_14
#define MAX6675_SO_GPIO_Port GPIOB
#define NO_Pin GPIO_PIN_15
#define NO_GPIO_Port GPIOB
